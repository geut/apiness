...
Fork the project [on GitHub](https://github.com/geut/apiness) and check out your copy locally.

```bash
$ git clone git@github.com:username/apiness.git
$ cd apiness
$ npm install
$ git remote add upstream git://github.com/geut/apiness.git
```
